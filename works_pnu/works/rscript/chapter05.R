# Chapter 05
#이산변수(discrete variable)란 이산 할 수 있는 변수 == 셀 수 있는 변수
# !!!R프로그래밍은 함수호출, 파라미터 설정 능력이 중요!!!
...
#attr(*, "dimnames")=List of 2 col하나 row하나 2개
class(VADeaths)
mode(VADeaths)
...
airquality
str(airquality)
boxplot(airquality) #dot 이상치 *** iqr 공부
...
# 실습: pch 속성으로 산점도 그리기 
par(mfrow = c(2, 2))
plot(price, type = "o", pch = 5) #phc > 점모양 속성 50>2
